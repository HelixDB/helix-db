...
use super::secondary_backfill::SecondaryBackfillTuning;
...
pub struct DbConfig {
    ...
    secondary_backfill: SecondaryBackfillTuning,
...
impl DbConfig {
    ...
    pub fn new() -> Self {
        Self {
            ...
            secondary_backfill: SecondaryBackfillTuning::default(),
    ...
    pub const fn secondary_backfill(&self) -> SecondaryBackfillTuning {
        self.secondary_backfill
    }
...
impl DbConfig {
    ...
    pub fn with_secondary_backfill_tuning(mut self, tuning: SecondaryBackfillTuning) -> Self {
        self.secondary_backfill = tuning;
        self
    }
