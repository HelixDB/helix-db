...
| `independent_range_directions` | `test` | `crates/db/tests/independent_range_directions.rs` | Checks independent ASC/DESC identities, planner ordering, mutation maintenance, and drop/rebuild through public DDL and queries; `index-lifecycle-testing` adds cancellation after backfill. |
