//! Independent original pruning traversal; ownership changes must preserve it.

use helix_ast::expr::Predicate;

use crate::error::PlannerError;

use crate::analysis::labels::LabelScope;
use crate::analysis::{labels, scalar, PrunedPredicate};

pub(super) fn run(predicate: &Predicate) -> Result<PrunedPredicate, PlannerError> {
