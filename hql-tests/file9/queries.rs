...
.n_from_index("count", &24.5).collect_to::<Vec<_>>();
let mut return_vals: HashMap<String, ReturnValue> = HashMap::new();
        ...
        return_vals.insert("node_by_name".to_string(), ReturnValue::from_traversal_value_array_with_mixin(node_by_name.clone(), remapping_vals.borrow_mut()));
