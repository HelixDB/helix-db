...
pub struct file16Input {

pub name: String
}
#[handler]
pub fn file16 (input: &HandlerInput, response: &mut Response) -> Result<(), GraphError> {
let data: file16Input = match sonic_rs::from_slice(&input.request.body) {
    Ok(data) => data,
