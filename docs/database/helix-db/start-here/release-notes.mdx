---
title: 'Release notes'
description: 'New features and changes in HelixDB, Helix Cloud, the SDKs, and the CLI'
rss: true
pageType: "Reference"
---
...
- **[Vector prefiltering](/database/helix-db/query-guides/prefiltering#vector-prefiltering)** — traverse and filter an exact candidate set before vector ranking, so results cannot escape graph or permission boundaries.
</Update>
...
<Update
  ...
  rss={{
    ...
    description: "Major performance improvements and better reliability"
  }}
>
