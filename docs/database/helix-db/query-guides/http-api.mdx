...
[query error reference](/database/helix-db/query-guides/error-handling) for engine
error codes and retry guidance, and
[Helix Cloud gateway errors](/database/helix-cloud/operate/error-handling) for
gateway codes.
