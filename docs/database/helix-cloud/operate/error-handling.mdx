...
The table below lists codes produced by the Cloud gateway itself. Errors raised by the
database engine behind it use the same envelope; see the
[query error reference](/database/helix-db/query-guides/error-handling) for those codes.
